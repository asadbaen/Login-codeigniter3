                                    ...
                                    <?php foreach ($menu as $key) : ?>
                                        <tr>
                                            ...
                                            <td><span class="tag tag-success">
                                                    <a href="<?= site_url('menu/edit/' . $key['user_menu_id']); ?>" class="badge badge-primary"><i class="fas fa-edit"></i></a>
...
<div class="modal fade" id="newMenuModal" tabindex="-1" role="dialog" aria-labelledby="newMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php site_url('menu/addMenu') ?>" method="post">
...
<!-- <div class="modal fade" id="updateMenuModal" tabindex="-1" role="dialog" aria-labelledby="updateMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url(); ?>menu/update/<?= $menu['user_menu_id']; ?>" method="post">
                <input type="hidden" name="user_menu_id" value="<?= $menu['user_menu_id']; ?>">
                <div class="modal-body">
                    <div class="form-group">
